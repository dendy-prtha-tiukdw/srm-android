...
public enum HttpStatus {
     ...
     * {@link id.ukdw.srmmobile.utils.HttpStatus.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link  id.ukdw.srmmobile.utils.HttpStatus.Series#SUCCESSFUL}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link  id.ukdw.srmmobile.utils.HttpStatus.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link  id.ukdw.srmmobile.utils.HttpStatus.Series#CLIENT_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link  id.ukdw.srmmobile.utils.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @see #series()
     */
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link  id.ukdw.srmmobile.utils.HttpStatus.Series#CLIENT_ERROR} or
     * {@link  id.ukdw.srmmobile.utils.HttpStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     * @since 5.0
